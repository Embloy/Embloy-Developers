...
:::warning
Since Lever doesn't provide a Webhook for updates of your postings' application forms, **whenever you create or edit a posting**, you will have to re-synchronize the jobs by pressing the _Refresh postings_-icon in the [**Integrations**](https://genius.embloy.com/settings?tab=integrations)-tab of Embloy's Recruiter Dashboard.
:::
