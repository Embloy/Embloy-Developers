...
:::tip
To see examples and detailed information on how to use the SDKs (e.g., what to set as `job_slug` or `mode`), please take a look at our [tutorials](/docs/category/tutorial---basics), [guides](/docs/category/guides) for your use case or the ["How to integrate Quicklink" page](/docs/core/quicklink/quicklink_application#how-to-integrate-quicklink). 
:::
