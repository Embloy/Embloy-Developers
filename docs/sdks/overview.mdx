...
$session = new EmbloySession('mode', $jobSlug, [
...
:::note
Please note that all SDKs are currently in the beta phase. While they have been thoroughly tested, we recommend using them with care. The Ruby, Python and Node SDKs, in particular, have undergone extensive field testing and are expected to perform reliably.
:::
