...
:::warning
Currently, the Python SDK may encounter 403 Errors due to CORS issues. Efforts are underway to resolve this problem.
:::
...
:::note
Please note that all SDKs are currently in the beta phase. While they have been thoroughly tested, we recommend using them with care. The Ruby, Java, Go and Node SDKs, in particular, have undergone extensive field testing and are expected to perform reliably.
:::
